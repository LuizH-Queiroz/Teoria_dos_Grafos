...
bool GrafoSimples::LerArquivo(std::string nomeArquivo) {
    ...
    // Feita a leitura da Matriz e da Lista de adjacências, resta apenas
    // inicializar os valores do raio, diâmetro e distância média do grafo.
    // Como esses valores serão inválidos até que ocorra a Busca em Largura,
    // eles são inicializados com -1
    raio = -1;
    diametro = -1;
    distMedia = -1;
